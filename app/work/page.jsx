...
const projects = [
	{
		...
		title: "project 1",
		description:
			"Demo de una aplicación de logística con funcionalidades para mostrar reseñas, navegación a destinos personalizados y control de precipitaciones.",
		stack: [
			{ name: "React native" },
			{ name: "Mapbox" },
			{ name: "typescript" },
		...
		live: "",
		github: "https://github.com/sidernes/react-native-mapbox-demo",
	},
	{
		num: "02",
		category: "Backend",
		title: "project 2",
		description:
			"Backend multiproposito con validacion de acceso JWT, respaldo con base de datos y administracion de archivos",
		stack: [
			{ name: "NestJS" },
			{ name: "Websocket.io" },
			{ name: "PostgresSQL" },
